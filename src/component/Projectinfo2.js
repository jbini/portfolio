...
export function videoPause2() {
    $('#projectIframe2').get(0).pause();
};

let contentimg2 = eatmotion1
...
export default function Projectinfo2() {
    return(
        <div className='project-cover-container'>
            ...
            <label className='project-darkbg' id='project-darkbg1' for='project-dark' onClick={videoPause2}></label>
            ...
            <label className='project-box1' id='projectbox' for='project-info'>
                ...
                <div className='project-box-content1'>
                    <div className='project-box-content-img'><img src={contentimg2} alt='eatmotion'/></div>
            ...
            <label className='project-box2' id='projectbox' for='project-pre'>
                ...
                <label className='project-box-X2' for='project-dark' onClick={videoPause2}><h3>X</h3></label>
                <h3>PREVIEW</h3>
                <div className='project-box-content2'>
                    ...
                    <video id='projectIframe2' src={eatmotion} controls width="100%" height="100%" />
                </div>
            </label>
