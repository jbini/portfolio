            ...
            <label className='project-box3' id='projectbox' for='project-eva'>
                ...
                <div className='project-box-content3'>
                    ...
                    <div className='project-box-content-epilogue2'>
                        ...
                        <h5>작업 방식을 리액트로 변경하면서 코드 분류가 꼬여 막막해하는 팀원이 있었는데</h5>
                        <h5>파일을 하나하나 봐주며 경로 수정을 해줘서 해결한 경험이 있습니다.</h5>
                        <h5>팀원의 고마워하는 모습에 뿌듯함을 느꼈고, 개발자로서 자신감이 높아졌습니다.</h5>
                    </div>
                    ...
                    <div className='project-box-content-epilogue4'>
                        ...
                        <h5>팀원에게 가독성 좋고 일관성 있는 코드를 받고 나면, 전에 작업했던 코드에서 더 효율적인 방법이 보였습니다.</h5>
                        <h5>좋은 팀원은 직접 가르치는 것 없이도 혼자였다면 몰랐을 배움을 줬습니다.</h5>
                        <h5>여럿이 모일수록 가치가 빛나는 사람이 좋은 개발자라고 생각합니다.</h5>
                        <h5>협업에서 팀원 간의 발전을 추구하는 유동적인 개발자로서 임하겠습니다.</h5>
                    </div>
                </div>
            </label>
